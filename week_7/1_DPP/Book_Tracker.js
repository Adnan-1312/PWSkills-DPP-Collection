...
let action = prompt("Do you want to borrow or return a book?
(borrow/return/exit)");
...
console.log("Invalid action or the book is already in the
desired state.");
}
...
action = prompt("Do you want to borrow or return another book?
(borrow/return/exit)");
}
